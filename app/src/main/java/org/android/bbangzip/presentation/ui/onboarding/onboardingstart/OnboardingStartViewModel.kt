...
@Inject constructor(
    ...
    override fun reduceState(state: OnboardingStartContract.OnboardingStartState, reduce: OnboardingStartContract.OnboardingStartReduce): OnboardingStartContract.OnboardingStartState {
        return when (reduce) {
