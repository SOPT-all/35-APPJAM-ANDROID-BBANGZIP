...
fun AddStudyRoute(
    ...
    if (addStudyState.isSuccess) {
        AddStudyScreen(
            ...
            datePickerBottomSheetState = addStudyState.isDatePickerBottomSheetVisible,
            piecePickerBottomSheetState = addStudyState.isPiecePickerBottomSheetVisible,
            studyContentTextFieldState = addStudyState.studyContentTextFieldInputState,
            startPageTextFieldState = addStudyState.startPageTextFieldInputState,
            endPageTextFieldState = addStudyState.endPageTextFieldInputState,
            isSplitBtnEnable = addStudyState.isSplitBtnEnabled,
            isButtonEnable = addStudyState.isEnrollBtnEnabled,
