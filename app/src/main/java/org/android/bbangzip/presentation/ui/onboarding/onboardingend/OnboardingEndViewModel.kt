...
constructor(
    ...
    override fun reduceState(state: OnboardingEndContract.OnboardingEndState, reduce: OnboardingEndContract.OnboardingEndReduce): OnboardingEndContract.OnboardingEndState {
        return when (reduce) {
